...
## [3.24.0](https://github.com/snowdreamtech/dropbear/compare/alpine-v3.24.0...alpine-v3.24.0) (2026-06-21)
...
* **alpine:** add empty line to trigger release pipeline test ([6f32fb1](https://github.com/snowdreamtech/dropbear/commit/6f32fb1c9fae9bcd4e86beb2e3013a0138784372))
...
* **docker:** pin dropbear subpackages to exact version in alpine ([485c5cb](https://github.com/snowdreamtech/dropbear/commit/485c5cb6e52f604a0357506d49f8579fb8e408ec))
...
* **docker:** remove fallback logic in builder stage to enforce strict version pinning ([496ee6e](https://github.com/snowdreamtech/dropbear/commit/496ee6e17ef2b35877d3d34cf1f6c06af7f2dbbf))
